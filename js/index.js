...
function Coffee(size, isDecaf, qtyCream, qtySugar) {
    ...
    this.description = function () {
        output.textContent = `A ${this.size} ${this.decaf} coffee 
        with ${this.qtyCream} cream annd ${this.qtySugar} sugar.`;
    }
}

/* STEP 2: Instatiate a coffee based on the above constructor function */
var priyanshCoffee = new Coffee("medium", false, 2, 1);
...
var robertCoffee = Object.create(priyanshCoffee);
robertCoffee.size = "large";
robertCoffee.isDecaf = true;
robertCoffee.qtyCream = 3;
robertCoffee.qtySugar = 3;
...
var meganCoffee = new robertCoffee.constructor("small", true, 2, 0);
...
Coffee.prototype.thanks = function () {
    output.textContent = `Thank you for a ${this.size} coffee.`
}
